...
export async function judgeToken(tokenName, options = {}) {
  ...
  if (options?.force) {
    ...
    const verdictPayload = { token_name: tokenName, status, score: normalised, councilCertified, hardRuleTrigger, totalJudges, details, forced: true };
  ...
  const verdictPayload = { token_name: tokenName, status, score: normalised, councilCertified, hardRuleTrigger, totalJudges, details };
