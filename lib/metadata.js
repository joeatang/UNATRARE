...
function buildApprovedJson(token) {
  ...
  return {
    ...
    // `image`: full canonical art URL — matches how RAREPEPE and major Counterparty
    // platforms publish enhanced asset info. Wallets (Freewallet, Rarepepewallet)
    // scale this to their thumbnail slot. For video tokens, use the cover icon instead
    // since video URLs can't be displayed as static thumbnails in wallet lists.
