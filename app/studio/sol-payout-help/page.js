...
import styles from '../../status/sol-payout-help/sol-payout-help.module.css';

export const metadata = {
  title: 'Artist Studio — SOL Payout Help — UNATRARE',
  description: 'Simple guide for artists to set SOL payout address inside UNATRARE Artist Studio.',
};

export default function StudioSolPayoutHelpPage() {
  return (
    <>
      <Nav />
      <main className={styles.page}>
        <div className={styles.wrap}>
          <Link href="/studio" className={styles.backLink}>← back to artist studio</Link>
          ...
          <section className={styles.card}>
            ...
            <ol className={styles.steps}>
              <li>
                Open <strong>Manage your listing</strong> on your token in Artist Studio.
              </li>
              <li>
          ...
          <div className={styles.ctaRow}>
            <Link href="/studio" className={styles.ctaPrimary}>go set payout address →</Link>
          </div>
        </div>
      </main>
    </>
